...
from browser.handle_element import find_element, button_click, select_value, input_value
from browser.xpath import HOME, ADDRESS
...
class Api:
  ...
  def query_address(self, data):
    ...
    button_click(driver, ADDRESS['因公查詢鈕'])
